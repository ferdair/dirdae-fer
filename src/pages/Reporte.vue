<template>
  <q-page>
    <div class="row">
      <div class="text-h4 text-bold q-pa-md q-pt-xl">Reporte del Proyecto</div>
    </div>
    <q-separator inset />

    <div class="full-width row wrap justify-start items-stretch content-start">
      <div class="col-3">
        <div class="q-pa-xs">
          <q-card class="my-card">
            <div class="row">
              <div class="col-12">
                <div class="text-subtitle2 q-pa-md">Prioridad</div>
              </div>
              <div class="col-12">
                <div class="text-h6 q-pl-md">{{ criterioPrioridad.suma }}</div>
              </div>
            </div>
          </q-card>
        </div>
      ...
      <div class="col-9">
        <div class="q-pa-xs">
          <q-card class="my-card">
            <div class="row">
              <div class="col-12">
                <div class="text-subtitle2 q-pt-md q-pl-md">Proyecto</div>
              </div>
              <div class="col-12">
                <div class="text-subtitle1 q-pl-md q-pt-md">
                  {{ nombre }}
                </div>
              </div>
            </div>
    ...
    <div class="row">
      <div class="text-h5 text-bold q-pa-md">Criterios de Prioridad</div>
    </div>
    <q-separator inset />
    ...
    <div class="row">
      <div class="col-4">
        <div class="q-pa-xs">
          <q-card class="my-card">
            <div class="row">
              <div class="text-subtitle1 q-pl-md">Requerimiento Operativo</div>
            </div>
            <div class="row">
              <div class="text-h6 q-pl-md">
                {{ criterioPrioridad.requerimientoOperativo }}
              </div>
            </div>
          </q-card>
        </div>
      ...
      <div class="col-4">
        <div class="q-pa-xs">
          <q-card class="my-card">
            <div class="row">
              <div class="text-subtitle1 q-pl-md">Sostenimiento Log A-29</div>
            </div>
            <div class="row">
              <div class="text-h6 q-pl-md">
                {{ criterioPrioridad.sostenimientoLogA29 }}
              </div>
            </div>
          </q-card>
        </div>
      ...
      <div class="col-4">
        <div class="q-pa-xs">
          <q-card class="my-card">
            <div class="row">
              <div class="text-subtitle1 q-pl-md">Sostenimiento DA-20</div>
            </div>
            <div class="row">
              <div class="text-h6 q-pl-md">
                {{ criterioPrioridad.sostenimientoDA20 }}
              </div>
            </div>
          </q-card>
        </div>
          ...
          <q-card class="my-card">
            <div class="row">
              <div class="text-subtitle1 q-pl-md">
                Aporte Lineas Investigación
              </div>
            </div>
            <div class="row">
              <div class="text-h6 q-pl-md">
                {{ criterioPrioridad.aporteLineasInvestigativo }}
              </div>
            </div>
          </q-card>
        </div>
      ...
      <div class="col-4">
        <div class="q-pa-xs">
          <q-card class="my-card">
            <div class="row">
              <div class="text-subtitle1 q-pl-md">Criterio del Director</div>
            </div>
            <div class="row">
              <div class="text-h6 q-pl-md">
                {{ criterioPrioridad.criteriodelDirector }}
              </div>
            </div>
          </q-card>
        </div>
      ...
      <div class="col-4">
        <div class="q-pa-xs">
          <q-card class="my-card">
            <div class="row">
              <div class="text-subtitle1 q-pl-md">Dispone de Presupuesto</div>
            </div>
            <div class="row">
              <div class="text-h6 q-pl-md">
                {{ criterioPrioridad.disponedePresupuesto }}
              </div>
            </div>
          </q-card>
        </div>
    ...
    <div class="row">
      <div class="text-h5 text-bold q-pa-md">Detalles</div>
    </div>
    <q-separator inset />

    <div class="row justify-center full-height full-width q-py-md">
      <div class="col-4">
        <div class="text-h6 q-pl-xl">Unidad Beneficiaria</div>
      </div>
      <div class="col-8">
        <div class="text-h5 q-pl-md">{{ unidadBeneficiaria }}</div>
      </div>
    </div>
    <div class="row justify-center full-height full-width q-py-md">
      <div class="col-4">
        <div class="text-h6 q-pl-xl">Capacidades Genéricas</div>
      </div>
      <div class="col-8">
        <div class="text-h5 q-pl-md">{{ capacidadGenerica }}</div>
      </div>
    </div>

    <div class="row justify-center full-height full-width q-py-md">
      <div class="col-4">
        <div class="text-h6 q-pl-xl">Jefe de Proyecto</div>
      </div>
      <div class="col-8">
        <div class="text-h5 q-pl-md">{{ jefeProyecto }}</div>
      </div>
    </div>
    <div class="row justify-center full-height full-width q-py-md">
      <div class="col-4">
        <div class="text-h6 q-pl-xl">Línea Básica de Investigación</div>
      </div>
      <div class="col-8">
        <div class="text-h5 q-pl-md">
          {{ lineaInvestigacion }}
        </div>
      </div>
    </div>
    <div class="row justify-center full-height full-width q-py-md">
      <div class="col-4">
        <div class="text-h6 q-pl-xl">Línea Específica de Investigación</div>
      </div>
      <div class="col-8">
        <div class="text-h5 q-pl-md">
          {{ lineaEspecifica }}
    ...
    <div class="row">
      <div class="text-h5 text-bold q-pa-md">Fases</div>
    </div>
    <q-separator inset />

    <div class="row justify-center full-height full-width q-py-md">
      <div class="col-4">
        <div class="text-h6 q-pl-xl">Inicio de Proyecto</div>
      </div>
      <div class="col-8">
        <div class="text-h5 q-pl-md">22/03/2021</div>
      </div>
    </div>
    <div class="row justify-center full-height full-width q-py-md">
      <div class="col-4">
        <div class="text-h6 q-pl-xl">Fin de Proyecto</div>
      </div>
      <div class="col-8">
        <div class="text-h5 q-pl-md">22/03/2021</div>
      </div>
    ...
    <div class="row justify-center full-height full-width q-py-md">
      <div class="col-4">
        <div class="text-h6 q-pl-xl">Duración</div>
      </div>
      <div class="col-8">
        <div class="text-h5 q-pl-md">70 días</div>
      </div>
    </div>
    <div class="row justify-center full-height full-width q-py-md">
      <div class="col-12">
    ...
    <div class="row">
      <div class="text-h5 text-bold q-pa-md">Diagrama de gantt</div>
    </div>
    <q-separator inset />
...
const columns = [
  ...
  { name: "finalización", label: "Finalización", field: "finalizacion" },
  { name: "dias_cumplidos", label: "Días Cumplidos", field: "dias_cumplidos" },
  {
    name: "porcentaje_ejecutado",
    label: "% Ejecutado",
    field: "porcentaje_ejecutado",
  },
  { name: "dias_retraso", label: "Días Retraso", field: "dias_retraso" },
  {
    name: "porcentaje_retraso",
    label: "% Retraso",
    field: "porcentaje_retraso",
  },
  {
  ...
  {
    name: "presupuesto_requerido",
    label: "Presupuesto Requerido",
    field: "presupuesto_requerido",
  },
];
...
const columns2 = [
  ...
  },
  {
    name: "organizacional",
    align: "center",
    label: "Factor Organizacional",
    field: "organizacional",
    sortable: true,
  },
];
...
const rows2 = [
  {
    ...
    finalizacion: 24,
    dias_cumplidos: 4.0,
    porcentaje_ejecutado: 87,
    dias_retraso: "14%",
    porcentaje_retraso: "1%",
    presupuesto_total: 1,
    presupuesto_requerido: 1,
  },
  {
    fases: "Frozen Yogurt",
    inicio: 159,
...
export default defineComponent({
  ...
  methods: {
    init(id) {
      ...
      var categories = this.categorias;
      ...
      this.charts.setOption({
          ...
          formatter: function (params) {
            ...
            if (params.value[3]) {
              ...
              practiceStartDate_str =
                "Fecha de inicio real：" + practiceStartDate + "<br/>";
            }
            ...
            if (currentProgress_percentage == 100) {
              ...
              practiceEndDate_str =
                "Fecha de finalización real：" + practiceEndDate + "<br/>";
            }
            return (
              params.name +
              "<br/>" +
              ...
              planStartDate +
              "<br/>" +
              "Planificar la hora de finalización:" +
              planEndDate +
              "<br/>" +
              "Ciclo del proyecto:" +
              projectCycle_days +
        ...
        legend: {
          left: "70%",
          top: 10,
          data: ["Duración planificada", "Duración real"],
        },
        series: [
          {
            type: "custom",
    ...
    async getProyectoById(ide) {
      ...
      this.capacidadGenerica = Proyecto[0].CapacidadesGenericas.nombreDetalle;
      this.criterioPrioridad = Proyecto[0].CriterioPrioridad;
      this.jefeProyecto = Proyecto[0].JefeProyecto.nombre;
      this.lineaInvestigacion = Proyecto[0].LineasInvestigacion.nombreDetalle;
      this.lineaEspecifica =
        Proyecto[0].LineaEspecificaInvestigacion.nombreDetalle;
      this.tipoProyecto = Proyecto[0].TipoProyecto.nombreDetalle;
      this.unidadBeneficiaria = Proyecto[0].UnidadBeneficiaria.nombreDetalle;
    },
  },
});
</script>
